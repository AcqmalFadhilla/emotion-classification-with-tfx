...
from tfx.dsl.componenets.common.resolver import Resolver
from tfx.types.standard_artifacts import Model, ModelBlessing
from tfx.dsl.input_resolution.strategies.latest_blassed_model_strategy import (
...
def init_components(
    ...
    Args:
        ...
        eval_steps (int): numver of eval steps
    ...
    examples=example_gen.outputs['examples'],
    schema= schema_gen.outputs['schema'],
    module_file=os.path.abspath(utils_module))
